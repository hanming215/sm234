...
public class SM2TestParams {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		System.out.println("------------公钥加密与解密算法  标准数据正确性验证------------");
		...
		//System.out.println("私钥:\n" + privateKey.totoString(16).toUpperCase());
		System.out.println("私钥:");
		printHexString(privateKey.toByteArray());
		
		//System.out.println("公钥:\n"+publicKey);
		//publicKeyX=publicKey.getXCoord()
		System.out.println("公钥X坐标:");
	
		printHexString(publicKey.getRawXCoord().getEncoded());
		System.out.println("公钥Y坐标:");
		printHexString(publicKey.getRawYCoord().getEncoded());
				
		String input="encryption standard";

		System.out.println("待加密的消息："+input);
		System.out.println("明文16进制:");
		printHexString(input.getBytes());
		
		
		byte[] data = sm02.encrypt(input, publicKey);
		System.out.print("密文:\n");
		...
		System.out.println("数字签名(r,s)");
		System.out.print("r: ");
		printHexString(signature.r.toByteArray());
		System.out.print("s: ");
		printHexString(signature.s.toByteArray());
		...
		System.out.println("-----------------密钥协商算法 标准数据正确性验证-----------------");
		
		String aID = "ALICE123@YAHOO.COM";
		
		
		System.out.println("设用户A的身份是："+ aID);
		...
		System.out.println("设用户B的身份是："+ bID);
